...
async def get_book(
    ...
    # Kitob ijaralar soni
    borrow_count = db.query(func.count(Borrowing.borrow_id)).filter(
...
# Routes moduldan barcha endpointlarni import qilish
...
async def health_check():
    """Tizim ishlayotganini tekshirish"""
    return {
        "status": "healthy",
        "app": "Kutubxona Boshqaruv Tizimi",
        "version": "1.0.0"
    }
